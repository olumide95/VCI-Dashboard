...
<html>
    ...
    <head>
        ...
        <title>Verify Customer Info <?php echo $__env->yieldContent('title'); ?></title>
        ...
        <div class="main-wrapper">
            <div class="header">
                <div class="header-left">
					<?php if(!Auth::user()->isOrganisation()): ?>
			...
			<?php echo $__env->renderWhen(Auth::user()->isOrganisation(),'sidebar.organisation', array_except(get_defined_vars(), array('__data', '__path'))); ?>
	...
	toastr.info('<?php echo e(Session::get('success')); ?>')
