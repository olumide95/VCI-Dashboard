...
<?php $__env->startSection('organisations-requests_active', 'active'); ?>
										...
										<tr>
											...
											<td class="text-right">
												<div class="dropdown">
													...
													<a  href="<?php echo e(url('/admin/requests/update/status')); ?>/<?php echo e($request->id); ?>"><i class="fa fa-pencil m-r-5"></i> Completed</a>
                                                    </li>
