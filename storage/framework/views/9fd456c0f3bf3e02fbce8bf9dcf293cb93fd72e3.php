...
<?php $__env->startSection('content'); ?> 
  <div class="page-wrapper">
                <div class="content container-fluid">
					<div class="row">
						<div class="col-xs-4">
							<h4 class="page-title">Update <?php echo e($user->name); ?></h4>
						</div>
					</div>
						<?php if($errors->any()): ?>
  ...
  <form class="form-horizontal" method="POST" action="<?php echo e(route('users.update',$user->id)); ?>"  >
                        ...
                        <div class="form-group<?php echo e($errors->has('role') ? ' has-error' : ''); ?>">
                            ...
                            <select class="form-control" type="text" name="roles" required>
                                ...
                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
								 <option value="<?php echo e($role); ?>" <?php if(isset($userRole[$role])): ?> <?php echo e('selected'); ?> <?php endif; ?>><?php echo e($role); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control" name="email" value="<?php echo e($user->email); ?>" required autocomplete="off" >
